 ...
 */
package com.example.binht.thoitiet.data;
    ...
    */
    public long testLocationTable() {
        ...
        Cursor cursor=db.query(WeatherContract.LocationEntry.TABLE_NAME,
                null, //all columns
                null, //columns for the Where clauss
                null, //Values for the Where clause
                null, //columns for the group by
                null, //columns for filter by row group
                null); //sort order
        assertTrue("Error: no record returned from location query!",cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Location Query ValidateCurrent Failed!",cursor,testValues);
    ...
    public void testWeatherTable() {
        ...
        Cursor cursor=db.query(WeatherContract.WeatherEntry.TABLE_NAME,
                ...
                null,
                null);
        assertTrue("Error: no record returned from weather query!",cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather Query ValidateCurrent Failed!",cursor,testValues);
        // Finally, close the cursor and database
        cursor.close();
        dbHelper.close();
